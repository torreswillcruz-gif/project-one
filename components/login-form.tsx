      ...
      <section className="auth-visual">
        <div className="auth-overlay">
          ...
          <div className="auth-copy">
            ...
            <h1>Good work starts with a clear <span>direction.</span></h1>
          </div>
        </div>
      </section>
        ...
        <div className="auth-card">
          ...
          <form className="login-form" onSubmit={handleSubmit}>
            ...
            <div className="form-row">
              ...
              <a href={`mailto:${COMPANY_EMAIL}?subject=Reset%20password`}>Forgot password?</a>
            </div>
            <button type="submit" className="button primary-btn" disabled={loading}>{loading ? 'Signing in...' : 'Sign in ↗'}</button>
          </form>

          <p className="signup-copy">
            New to {COMPANY_NAME}? <Link href="/users">Request an account</Link>
          </p>
        </div>
      </section>
    </main>
